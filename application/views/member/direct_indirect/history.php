                            ...
                            <?php if ( isset( $direct_indirect_withdraw ) ):?>
                                ...
                                <?php foreach($direct_indirect_withdraw as $item): ?> 
                                    ...
                                    <tr>
                                        ...
                                        <td>₱ <?php echo number_format( $item['diw_amount'], 3) ?></td>
                                        <td>₱ <?php echo number_format( $item['diw_lastamount'], 3) ?></td>
                                        
                                        <td>₱ <?php echo number_format( $item['diw_realamount'], 3) ?></td>
                                        <td>₱ <?php echo number_format( $item['diw_proccess'], 3) ?></td>
                                        <td>₱ <?php echo number_format( $item['diw_tax'], 3) ?></td>
                                        
                                        <td>₱ <?php echo number_format( $item['diw_leftamount'], 3) ?></td>
