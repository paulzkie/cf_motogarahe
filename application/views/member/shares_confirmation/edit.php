            ...
            <form method="POST">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="pro_name" value="<?php echo set_value('pro_name') != NULL ? set_value('pro_name') : $product['pro_name'] ?>">
                    </div>

                    <div class="form-group">
                        <label>Product Code</label>
                        <input type="text" class="form-control" name="pro_code" value="<?php echo set_value('pro_code') != NULL ? set_value('pro_code') : $product['pro_code'] ?>">
                    </div>
