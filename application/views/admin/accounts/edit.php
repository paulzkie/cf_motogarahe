                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="acc_type">
                            ...
                            <option value="ojt" <?php echo 'ojt' == $account['acc_type'] ? 'selected' : '' ?>>Ojt</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Account Status:</label>
                        <select class="form-control" name="acc_status">
                            <option value="published" <?php echo 'published' == $account['acc_status'] ? 'selected' : '' ?>>Published</option>
                            <option value="draft" <?php echo 'draft' == $account['acc_status'] ? 'selected' : '' ?>>Draft</option>
                            <option value="deleted" <?php echo 'deleted' == $account['acc_status'] ? 'selected' : '' ?>>Delete</option>
                        </select>
                    </div>
                    <!--<div class="form-group">-->
