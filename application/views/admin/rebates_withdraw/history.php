                            ...
                            <?php if ( isset( $rebates_withdraw ) ):?>
                                ...
                                <?php foreach($rebates_withdraw as $item): ?> 
                                    ...
                                    <tr>
                                        ...
                                        <?php if ( $item['rew_updated'] != "0000-00-00 00:00:00" ): ?>
                                            <td><?php echo date("F j, Y, g:i a",strtotime($item['rew_updated'])) ?></td>
                                        <?php else:?>  
                                            <td></td>  
                                        <?php endif;?>    
                                        <td>    
                                        <div class="tools">
                                            <?php if ( $item['rew_get'] == 'no' ) :?>
                                            <a href="<?php echo base_url() . 'admin/rebates_withdraw/confirm/' . $item['rew_id']?>"><i class="fa fa-check"></i></a>
                                            <?php endif;?>
