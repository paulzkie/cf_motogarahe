            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" autocomplete="off" class="form-control" name="mot_keyword" value="<?php echo set_value('mot_keyword'); ?>" placeholder="Brand/Model">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="mot_brand">
                            ...
                            <option value="Kawasaki-Bajaj">Kawasaki Bajaj</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="mot_desc" value="<?php echo set_value('mot_desc'); ?>" required cols="30" rows="10"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea  class="form-control" class="form-control" name="mot_promo_content" cols="30" rows="3" name="mot_promo_content"></textarea>
                    </div>
                    <!-- <div class="form-group">
                            <label>Image</label>
        ...
        <div class="col-md-8">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>Engine Type / Motor Type</label>
                    ...
                    <div class="form-group">
                        <label>Battery (for Ebike)</label>
                        <input type="text" autocomplete="off" class="form-control" name="mot_battery" value="<?php echo set_value('mot_battery'); ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" autocomplete="off" class="form-control" name="mot_range" value="<?php echo set_value('mot_range'); ?>">
                    </div>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" autocomplete="off" class="form-control" name="mot_alarm" value="<?php echo set_value('mot_alarm'); ?>">
                    </div>
