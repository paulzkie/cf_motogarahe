...
<div class="row">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input readonly type="text" class="form-control" name="mot_keyword" value="<?php echo set_value('mot_keyword') != NULL ? set_value('mot_keyword') : $motorcycle['mot_keyword'] ?>">
                    </div>

                    <div class="form-group">
                        <label>SRP</label>
                        <input readonly type="text" class="form-control" name="mot_srp" value="<?php echo set_value('mot_srp') != NULL ? set_value('mot_srp') : $motorcycle['mot_srp'] ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea disabled class="form-control" class="form-control" name="mot_desc" cols="30" rows="10" name="mot_desc"><?php echo set_value('mot_desc') != NULL ? set_value('mot_desc') : $motorcycle['mot_desc'] ?></textarea>
                    </div>

                    <div class="form-group">
                        <label>Promo</label>
                        <select disabled class="form-control" name="mot_promo">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" readonly="" class="form-control" name="mot_discountpromo" value="<?php echo $motorcycle['mot_discountpromo']?>">
                    </div>

                    <div class="form-group">
                        <label>Promo Content</label>
                        <textarea disabled class="form-control" class="form-control" name="mot_promo_content" cols="30" rows="3" name="mot_promo_content"><?php echo set_value('mot_promo_content') != NULL ? set_value('mot_promo_content') : $motorcycle['mot_promo_content'] ?></textarea>
                    </div>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input readonly type="text" class="form-control" name="mot_battery" value="<?php echo set_value('mot_battery') != NULL ? set_value('mot_battery') : $motorcycle['mot_battery'] ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input readonly type="text" class="form-control" name="mot_range" value="<?php echo set_value('mot_range') != NULL ? set_value('mot_range') : $motorcycle['mot_range'] ?>">
                    </div>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input readonly type="text" class="form-control" name="mot_alarm" value="<?php echo set_value('mot_alarm') != NULL ? set_value('mot_alarm') : $motorcycle['mot_alarm'] ?>">
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function (e){
            $("#uploadwebpic").on('submit',(function(e){
            e.preventDefault();
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url()?>" + "admin/motorcycles/views"+"/"+<?php echo $this->uri->segment(4)?>,
                    ...
                    success: function(data){
                        $("#msgdesc").html(data);
                        $("#myModalmsg").show();
                        $("#webpicsection").load("<?php echo base_url()?>" + "admin/motorcycles/view"+"/"+"<?php echo $this->uri->segment(4)?>"+" .autoload");
                        document.getElementById('uploadwebpic').reset();
                        timer = setInterval(function(){ $("#myModalmsg").fadeOut('slow'); clearInterval();}, 2500);
                        
                    // var val = JSON.parse(data);
                    //     if(val.stat=="1"){
                    //         $("#myModal").show();    
                    //         $("#showpopup").html(val.msg);  
                    //     }
                    //     else{
                    //         $("#myModal").show();    
                    //         $("#showpopup").html(val.msg);
        ...
        $(document).on("click",".removewebpic",function(){
            mopid = $(this).data("mopid");
            motid = $(this).data("motid");
            $.ajax({
                type: "GET",
                url: "<?php echo base_url()?>" + "admin/motorcycles/delete_picture"+"/"+mopid+"/"+motid,
                success:function(data){
                    $("#msgdesc").html(data);
                    $("#myModalmsg").show();
                    $("#webpicsection").load("<?php echo base_url()?>" + "admin/motorcycles/view"+"/"+"<?php echo $this->uri->segment(4)?>"+" .autoload");
                    timer = setInterval(function(){ $("#myModal").fadeOut('slow'); clearInterval();}, 2500);
    ...
    <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <form class="form-inline" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="mot_id" value="<?php echo $motorcycles[0]['mot_id']?>">
                    <input type="hidden" name="img_type" value="fb">
                    <div class="form-group">
                            <label>Upload Facebook/SEO Image</label>
                            <input type="file" name="mot_fb_img[]" multiple="multiple">
                    </div>

                    <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-flat btn-xs" name="fb_pic" value="fb_pic" style="margin-top: 20px;">
                        <i class="fa fa-check" aria-hidden="true"></i> Submit Image
                        </button>
                    </div>
                </form>
                      <?php if( $motorcycle['mot_fb_img'] == 'none' ||  $motorcycle['mot_fb_img'] == 'deleted' ): ?>
                        <div class="card_motorss">
                      ...
                      <?php else:?>
                        <div class="card_motors">
                            <div class="close">
                                <a href="<?php echo base_url('admin/motorcycles/delete_picture_fb'). '/' . $motorcycle['mot_id'] ?>"><i class="fa fa-times" style="color: red;"></i></a>
                            </div>
                            <img class='img-responsive img-thumbnail' src="<?php echo base_url() . $motorcycle['mot_fb_img']?>" style="width: 204px; height: auto;margin-bottom: 5px;"/>
                        </div>

                      <?php endif;?> 
                <form class="form-inline" method="POST" enctype="multipart/form-data" id="uploadwebpic">
                   
                    <input type="hidden" name="mot_id" value="<?php echo $motorcycles[0]['mot_id']?>">
                    <input type="hidden" name="img_type" value="web">

                    <div class="form-group">
                            <label>Upload Website Images</label>
                            <input type="file" id="mop_image" name="mop_image[]" multiple="multiple">
                    </div>

                    <div class="form-group">
                        <button class="btn btn-primary btn-flat btn-xs" name="web_pic" value="web_pic" style="margin-top: 20px;">
                        <i class="fa fa-check" aria-hidden="true"></i> Submit Image
                        </button>
                    </div>
                </form>
                ...
                <?php foreach($motorcycles_pictures as $motorcycles_picture): ?>
                    ...
                    <?php if ( $motorcycles_picture['mop_image'] == 'none' ):?>
                        ...
                        <!--<div class="card_motorss">-->
                        <!--    <div class="close">-->
                        <!--        <a href="<?php echo base_url('admin/motorcycles/delete_picture'). '/' . $motorcycles_picture['mop_id'] . '/'. $motorcycles[0]['mot_id'] ?>"><i class="fa fa-times" style="color: red;"></i></a>-->
                        <!--    </div>-->
                        <!--    <img class='img-responsive img-thumbnail' src="https://dummyimage.com/620x485/4a4a4a/ffffff.jpg&text=No+Image" style="width: 204px; height: auto;margin-bottom: 5px;"/>-->
                        <!--</div>-->
                    ...
                    <?php else:?>
                        ...
                        <div class="card_motors autoload">
                            <div class="close">
                                <!-- <a href="<?php echo base_url('admin/motorcycles/delete_picture'). '/' . $motorcycles_picture['mop_id'] . '/'. $motorcycles[0]['mot_id'] ?>"><i class="fa fa-times" style="color: red;"></i></a>  -->
                                <a href="javascript:;" class="removewebpic" data-mopid="<?php echo $motorcycles_picture['mop_id']?>"
                                    data-motid="<?php echo $motorcycles[0]['mot_id']?>"><i class="fa fa-times" style="color: red;"></i></a>
                            </div>
                            <img class='img-responsive img-thumbnail' src="<?php echo base_url() . $motorcycles_picture['mop_image']?>" style="width: 204px; height: auto;margin-bottom: 5px;"/>
                        </div>
                ...
                <div class="box-body">
                    ...
                    <table class="table table-bordered table-hover" width="100%"> 
                        ...
                        <tbody> 
                            ...
                            <tr>
                                <td><?php echo $dealers_branch['dea_name']?></td>
                                <td><?php echo $dealers_branch['name']?></td>
                                <td><?php echo $dealers_branch['dem_price']?></td>
                                <td><?php echo $dealers_branch['dem_dp']?></td>
                                <td><?php echo $dealers_branch['dem_installment']?></td>
                                <td><?php echo $dealers_branch['dem_installment2']?></td>
                                <td><?php echo $dealers_branch['dem_installment3']?></td>
                                <td><?php echo $dealers_branch['dem_promo']?></td>
                            </tr>   
                            <?php endforeach;?>
                        </tbody>
                    </table>
