            ...
            <form method="post">
                <div class="box-header">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="bra_id_to">
                            <?php foreach ( $branches as $branch ) :?>
                                <?php if ( $branch['bra_name'] != $this->session->userdata('bra_name') ):?>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="int_ts" value="<?php echo set_value('int_ts'); ?>">
                    </div> -->
                    <div class="form-group">
                        <label>Picked Up By:</label>
                        <input type="text" class="form-control" name="int_pickup_by" value="<?php echo set_value('int_pickup_by'); ?>">
                    </div>
                    <div class="form-group">
                        <label>Delivered By:</label>
                        <input type="text" class="form-control" name="int_delivered_by" value="<?php echo set_value('int_delivered_by'); ?>">
                    </div>
                    <div class="form-group">
                        <label>Checked and Release By:</label>
                        <input type="text" class="form-control" name="int_checked_and_released_by" value="<?php echo set_value('int_checked_and_released_by'); ?>">
                    </div>
                </div>
                <div class="box-footer">
