            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select disabled class=" select2 form-control" name="mot_id" style="width: 100% !important;">
                    ...
                    <div class="form-group">
                        ...
                        <select disabled class=" select2 form-control" name="deb_id" style="width: 100% !important;">
                    ...
                    <!-- <div class="form-group">
                        ...
                        <input readonly type="text" class="form-control" name="dem_price" value="<?php echo set_value('dem_price') != NULL ? set_value('dem_price') : $dealers_motorcycle['dem_price'] ?>">
                    </div>

                    <div class="form-group">
                        <label>Downpayment</label>
                        <input readonly type="text" class="form-control" name="dem_dp" value="<?php echo set_value('dem_dp') != NULL ? set_value('dem_dp') : $dealers_motorcycle['dem_dp'] ?>">
                    </div>

                    <div class="form-group">
                        <label>36mos m.a.</label>
                        <input readonly type="text" class="form-control" name="dem_installment" value="<?php echo set_value('dem_installment') != NULL ? set_value('dem_installment') : $dealers_motorcycle['dem_installment'] ?>">
                    </div>

                    <div class="form-group">
                        <label>24mos m.a.</label>
                        <input readonly type="text" class="form-control" name="dem_installment2" value="<?php echo set_value('dem_installment2') != NULL ? set_value('dem_installment2') : $dealers_motorcycle['dem_installment2'] ?>">
                    </div>

                    <div class="form-group">
                        <label>12mos m.a.</label>
                        <input readonly type="text" class="form-control" name="dem_installment3" value="<?php echo set_value('dem_installment3') != NULL ? set_value('dem_installment3') : $dealers_motorcycle['dem_installment3'] ?>">
                    </div> -->

                    <!-- <div class="form-group">
                         <label>Promos List <small class="text-red">(**seperate with commas ",")</small></label>
                        <input readonly type="text" class="form-control" name="dem_promo" value="<?php echo set_value('dem_promo') != NULL ? set_value('dem_promo') : $dealers_motorcycle['dem_promo'] ?>">
                    </div> -->

                    <div class="form-group">
                        <label>Color Variant List <small class="text-red">(**seperate with commas ",")</small></label>
                        <input readonly type="text" class="form-control" name="dem_colors" value="<?php echo set_value('dem_colors') != NULL ? set_value('dem_colors') : $dealers_motorcycle['dem_colors'] ?>">
                    </div>

                    <div class="form-group">
                        <label>Status</label>
                        <select readonly class="form-control" name="dem_status">
                    ...
                    <div class="form-group">
                        ...
                        if($dealers_motorcycle['dem_promo']=='true'){
                            echo 'On';
                        }else{
                            echo 'Off';
                        }
