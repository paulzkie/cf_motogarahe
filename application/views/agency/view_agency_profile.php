                    ...
                    <form class="simple-from">
                        <div class="simple-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-block type-2 clearfix">
                                        <div class="form-label color-dark-2">Verify E-mail Address</div>
                                        <div class="input-style-1 b-50 brd-0 type-2 color-3">
                                    ...
                                    <div class="confirm-terms">
                                        <div class="input-entry color-3">
                                            ...
                                            <label class="clearfix" for="text-1">
                                                ...
                                                <span class="checkbox-text"> I want to receive <a class="color-dr-blue-2 link-dark-2" href="#">Let’s Travel</a> promotional offers in the future</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="simple-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-block type-2 clearfix">
                                        <div class="form-label color-dark-2">Billing Zip Code</div>
                                        <div class="input-style-1 b-50 brd-0 type-2 color-3">
                        ...
                        <a href="<?php echo base_url('tours_and_travel/tour_thankyou')?>" type="submit" class="c-button bg-dr-blue-2 hv-dr-blue-2-o" >confirm booking</a>
                    </form>
                </div>
                <div class="col-xs-12 col-md-4">
                    <div class="right-sidebar">
                        <div class="popular-tours bg-grey-2">
                            ...
                            <div class="hotel-small style-2 clearfix">
                                <a class="hotel-img black-hover" href="#">
                                    <img class="img-responsive radius-0" src="<?php echo SITE_IMG_PATH ?>home_9/cruise_1.jpg" alt="">
                            ...
                            <div class="hotel-small style-2 clearfix">
                                <a class="hotel-img black-hover" href="#">
                                    <img class="img-responsive radius-0" src="<?php echo SITE_IMG_PATH ?>home_9/cruise_2.jpg" alt="">
                                    <div class="tour-layer delay-1"></div>
                                </a>
                                <div class="hotel-desc">
                                    <h5><span class="color-dark-2"><strong>$273</strong>/ person</span></h5>
                            ...
                            <div class="hotel-small style-2 clearfix">
                                <a class="hotel-img black-hover" href="#">
                                    <img class="img-responsive radius-0" src="<?php echo SITE_IMG_PATH ?>home_9/cruise_3.jpg" alt="">
                                    <div class="tour-layer delay-1"></div>
                                </a>
                                <div class="hotel-desc">
                                    <h5><span class="color-dark-2"><strong>$273</strong>/ person</span></h5>
                        ...
                        <div class="help-contact bg-grey-2">
                            ...
                            <a class="help-phone color-dark-2 link-dr-blue-2" href="tel:0200059600"><img src="<?php echo SITE_IMG_PATH ?>detail/phone24-dark-2.png" alt="">020 00 59 600</a>
                            <a class="help-mail color-dark-2 link-dr-blue-2" href="http://demo.nrgthemes.com/cdn-cgi/l/email-protection#59353c2dbbd9c02a062d2b382f3c35192e362b353d773a3634"><img src="<?php echo SITE_IMG_PATH ?>detail/letter-dark-2.png" alt=""><span class="__cf_email__" data-cfemail="1f737a6bfd9f866c406b6d7e697a735f68706d737b317c7072">[email&#160;protected]</span>
