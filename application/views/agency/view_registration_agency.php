                    ...
                    <div class="f-login-content">
                        ...
                        <form class="f-login-form" action="" method="POST">
                            <div class="input-style-1 b-50 type-2 color-5">
                                <input type="text" name="age_username" placeholder="Enter your username" required>
                            </div>
                            <div class="input-style-1 b-50 type-2 color-5">
                                <input type="password" name="age_password" placeholder="Enter your password" required>
                            </div>
                            <div class="input-style-1 b-50 type-2 color-5">
                                <input type="text" name="age_businessname" placeholder="Enter your businessname" required>
                            </div>
                            <div class="input-style-1 b-50 type-2 color-5">
                                <input type="text" name="age_businessaddress" placeholder="Enter your businessaddress" required>
                            </div>
                            <div class="input-style-1 b-50 type-2 color-5">
                                <input type="text" name="age_fname" placeholder="Enter your firstname" required>
                            </div>
                            <div class="input-style-1 b-50 type-2 color-5">
                                <input type="text" name="age_mname" placeholder="Enter your middlename" required>
                            </div>
                            <div class="input-style-1 b-50 type-2 color-5">
                                <input type="text" name="age_lname" placeholder="Enter your lastname" required>
                            </div>
                            <div class="input-style-1 b-50 type-2 color-5">
                                <input type="text" name="age_address" placeholder="Enter your address" required>
                            </div>
                            <div class="input-style-1 b-50 type-2 color-5">
                                <input type="text" name="age_city" placeholder="Enter your city" required>
                            </div>
                            <div class="input-style-1 b-50 type-2 color-5">
                                <input type="text" name="age_state" placeholder="Enter your state" required>
                            </div>
                            <div class="drop-wrap drop-wrap-s-4 input-style-1 b-50 type-2 color-5" >
                                <div class="drop">
                                    <b>Country</b> 
                                    <a href="#" class="drop-list"><i class="fa fa-angle-down" style="overflow: auto; height: 50px;"></i></a>
                            ...
                            <div class="input-style-1 b-50 type-2 color-5">
                                <input type="text" name="age_zip" placeholder="Enter your zip" required>
                            </div>
                            <div class="input-style-1 b-50 type-2 color-5">
                                <input type="text" name="age_phone" placeholder="Enter your phone" required>
                            </div>
                            <div class="input-style-1 b-50 type-2 color-5">
                                <input type="text" name="age_email" placeholder="Enter your email" required>
                            </div>
