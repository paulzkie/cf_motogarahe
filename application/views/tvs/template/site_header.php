...
<meta charset="UTF-8" />
  ...
  <!-- custom css -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>resources/site/tvs-css/style.css">
  <!-- google fonts -->
...
<!-- desktop nav start -->
<nav id="main-nav" class="nav-header bg-tvs-blue border-tvs-bottom d-none d-md-block d-lg-block d-xl-block text-center">
  <div class="container ">
    <button class="btn nav-dropdown nav-link-desktop" href="#" role="button">
      <img class="icon-nav" src="<?php echo base_url() ?>resources/site/tvs-assets/nav/motor.png"><span class="icon-nav-text">MOTORCYCLES</span> 
          <div class="dropdown-menu">
           <!-- <h6 class="dropdown-header">Dropdown header</h6> -->
              <a class="dropdown-item nav-dd text-white" href="<?php echo base_url() ?>motorcycles/index/all/brand/type/transmission/diplacement/engine-type">New Motorcycle &nbsp; &nbsp; &nbsp;  &nbsp;</a>
          </div>
  </button>

  <a class="btn  nav-link-desktop" href="<?php echo base_url() ?>mgclub" role="button">
    <img class="icon-nav " src="<?php echo base_url() ?>resources/site/tvs-assets/nav/mgclublogo.png"><span class="icon-nav-text">MG CLUB </span> 
  </a>
   <a class="btn  nav-link-desktop" href="<?php echo base_url() ?>blogs" role="button">
    <img class="icon-nav" src="<?php echo base_url() ?>resources/site/tvs-assets/nav/interface.png"><span class="icon-nav-text">MG NEWS & BLOGS</span> 
   </a>
   <a class="btn  nav-link-desktop" href="<?php echo base_url() ?>aboutus" role="button">
    <img class="icon-nav " src="<?php echo base_url() ?>resources/site/tvs-assets/nav/aboutus.png"><span class="icon-nav-text">ABOUT US</span>
   </a>
   <button class="btn nav-dropdown nav-link-desktop" href="#" role="button">
            <img class="icon-nav " src="<?php echo base_url() ?>resources/site/tvs-assets/nav/star.png"><span class="icon-nav-text">MG EXCLUSIVE</span> 
            <div class="dropdown-menu">
                <a href="<?php echo base_url('tvs') ?>" class="dropdown-item nav-dd text-white" >TVS <img class="ex-logo-nav" src="<?php echo base_url() ?>resources/site/tvs-assets/exlogo.png"></a>
            </div>
    </button>
...
<!-- desktop nav end -->
<!-- nav end -->
<div class="bg-tvs-blue   bg-tvs-blue border-tvs-bottom d-sm-block d-md-none  d-lg-none d-xl-none " id="footer-spacer" style="height:15px">
</div>
<script>
