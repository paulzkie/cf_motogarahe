...
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>resources/site/tvs-css/moto-list.css">
...
<div class="body-content">
   <section class="search-filter-nav">
     <div class="container">
            <div class="row">
                <div class="col-6">
                    <h1 class="mot-title-text">NEW MOTORCYCLES</h1>
                </div>
                    ...
                    <ul class="navbar-nav col-lg-12">
                      <li class="has-search ">
                        ...
                        <span class="fa fa-search form-control-feedback"></span>
                         <input  autocomplete="off" id="model-search" class="form-control search-mot"  autocomplete="off" type="text" name="mot_model" value="<?php echo $mot_model != 'all' ? $mot_model : ''?>" placeholder="Search TVS model" inputmode="search">
                        </div>
                      </li>
      ...
      <!-- mobile filter start-->
         <div class="d-lg-none d-md-none">
            <div class="col-md-12 form-group has-search">
              <span class="fa fa-search form-control-feedback"></span>
              <input id="mobile" class="form-control"  autocomplete="off" type="text" name="mot_model_mobile" value="<?php echo $mot_model != 'all' ? $mot_model : ''?>" placeholder="Search TVS model" inputmode="search">
            </div>
  ...
  <section id="section-check" class="container">
    ...
    <?php   if($mot_brand != 'brand'){ echo '<button type="button" class="btn res-btn m-2" data-value="'.$mot_brand.'">'. strtoupper($mot_brand) .'</button>'; } ?>
    </span>   
...
<script>
    ...
    function load_data(limit, offset)
    {
      ...
      $.ajax({
        url:"<?php echo base_url(); ?>tvs/loadmotor",
        method:"post",
        data:{
          limit:limit, 
          offset:offset,
    ...
    function url_change(){
        //  var slugs = slugs.split(" ").join("-").toLowerCase();
         ...
         var brands = brand[0] == 'undefined' || brand[0] == null ? 'brand' : brand[0]  ;
         ...
         window.history.pushState('state', 'title','<?php echo base_url() ?>tvs/index/'+slugs+'/'+brands+'/'+types+'/'+transmissions+'/'+diplacements+'/engine-type' );
    }
