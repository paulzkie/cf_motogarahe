...
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>resources/site/tvs-css/inquiry.css">
        ...
        <div class="row" id="inq">
            ...
            <div class="col-md-6 col-sm-12 col-12" id="right-side">
                ...
                <div class="text-center">
                    <img src="<?php echo base_url() ?>resources/site/tvs-assets/tvslogov2.png" class="flex-fil tvs-logo ">
                </div>
                ...
                <div class="mot-info">
                    ...
                    <h2>₱<?php echo number_format($motorcycles[0]['mot_srp'],2)?></h2>
                    <div class="row">
                        <!-- color start -->
