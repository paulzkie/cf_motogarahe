            ...
            <div class="row">
            	<div class="col-sm-3 col-xs-4">
                  <div class="b-nav__logo hidden-xs ">
                        <a href="<?php echo base_url('home')?>"><img class="img  logo-img2" src="<?php echo base_url('resources/site/images/motogarahe_logo.png')?>">
                        </a>
                  </div>
               </div>

               <div class="col-sm-9 col-xs-8 pd-unset">
               	<div class="tag-line hidden-mob"> <img class="hidden-xs" src="<?php echo base_url('uploads/icon/hanapmototag.png') ?>"></div>
               	<div class="b-nav__list slideInRight" data-wow-delay="0.3s">
                     ...
                     <div class="b-nav__logo hidden-sm hidden-md hidden-lg" >
                          <div class=" col-xs-6"> 
                            ...
                            <img class="tag-line-mob img img-responsive" src="<?php echo base_url('uploads/icon/hanapmototag.png') ?>">
                            </a>
                          </div>
