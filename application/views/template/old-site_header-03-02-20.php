            ...
            <div class="row">
               <div class="col-md-12 col-xs-12">
                  <div class="b-topBar__addr">
                     ...
                     All the data in this website is inaccurate and for testing purposes only
                     <!-- <span id="myPlaceTextBox"></span>, --> <!-- <span id="myPlaceTextBox2"></span>, <span id="myPlaceTextBox3"> --></span>
                  </div>
               </div>
            </div>
         </div>
