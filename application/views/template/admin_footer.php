...
<script>
  ...
  $(".bootstrap-wysihtml5-insert-link-modal .modal-footer .btn-default").click(function( event ) {
    event.preventDefault();
    $( "body" ).removeClass( "modal-open" );
    $( ".wysihtml5-command-active" ).removeClass( "wysihtml5-command-dialog-opened" );
    $(".modal-backdrop").remove()
    $( ".bootstrap-wysihtml5-insert-link-modal" ).removeClass("in").hide()
