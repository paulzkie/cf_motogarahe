...
<section class="b-error home2">
	<div class="container">
		...
		<form class="b-blog__aside-search" id="formmm" method="post">
			<div>
				<input autocomplete="off" type="text" name="mot_model" value="" placeholder="What motorcycle is on your mind?" inputmode="search"/>
				<!-- <button type="submit" name="search_mode" value="search_mode"><span class="fa fa-search"></span></button> -->
			</div>  
			<div id="accordion" class="panel-group">
									...
									<div class="m-firstSelects">
										...
										<div class="col-xs-4">
											<select name="mot_diplacement">
												<option selected value>Diplacement</option>
										...
										<div class="col-xs-4">
											<select name="mot_engine_type">
												<option selected value>Engine Type</option>
												<option value="4s-sohc-4valve">4S SOHC 4VALVE</option>
												<option value="4s-sohc">4S SOHC</option>
												<option value="4s-dohc-2-cylinder">4S DOHC 2 CYLINDER</option>
											</select>
											<span class="fa fa-caret-down"></span>
										</div>
									</div>
			  ...
			  <div class="row">
			  	<div class="col-md-offset-2 col-md-4">
			  		<button type="submit" name="search_mode" value="search_mode" class="btn btn-default">New Motorcycles</button>
			  	</div>
			  	<div class="col-md-4">
			  		<a href="<?php echo base_url('repo/index/all/brand/type/transmission/diplacement/engine-type')?>" class="btn btn-default repo">Repo Motorcycles</a>
			  	</div>
			  </div>
		</form>
	</div>
