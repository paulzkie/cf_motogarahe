							...
							<div class="col-lg-4 col-md-6 col-xs-12 zoomInUp" data-wow-delay="0.5s">
								<div class="b-items__cell">
									<div class="b-items__cars-one-img">
										<img class='img-responsive' src="<?php echo base_url() . $rep['mot_image'] ?>" alt='mers'/>
									</div>
									<div class="b-items__cell-info">
										...
										<h5 class="b-items__cell-info-price" style="    position: inherit;"><span>Price:</span> &#8369;<?php echo number_format( $rep['mot_dp'], 2) ?></h5>
