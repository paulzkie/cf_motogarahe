					...
					<div class="row">
						...
						<div class="col-sm-3 col-xs-12">
							<div class="b-detail__head-price">
								<div class="b-detail__head-price-num">₱<?php echo number_format( $repo[0]['mot_price'], 2) ?></div>
									...
									<div class="row m-smallPadding">
										<div class="col-xs-10">
											<ul class="b-detail__main-info-images-big bxslider enable-bx-slider" data-pager-custom="#bx-pager" data-mode="horizontal" data-pager-slide="true" data-mode-pager="vertical" data-pager-qty="5">
												...
												<!--</li>-->
												<?php
											        foreach($repo_pictures as $repos){
											    ?>
												<li class="s-relative">                                        
													
													<img class="img-responsive center-block" src="<?php echo base_url() . $repos['mop_image'] ?>" alt="<?php echo $repos['mop_image']?>" />
												</li>							
												<?php }?>
											</ul>
										</div>
										<div class="col-xs-2 pagerSlider pagerVertical">
											<div class="b-detail__main-info-images-small" id="bx-pager">
												...
												<a href="#" data-slide-index="0" class="b-detail__main-info-images-small-one">
													<img class="img-responsive" src="<?php echo base_url() . $repos['mop_image'] ?>" alt="<?php echo $repos['mop_image']?>" />
												</a>							
												<?php }?>
												<!--<a href="#" data-slide-index="0" class="b-detail__main-info-images-small-one">-->
							...
							<aside class="b-detail__main-aside">
								<div class="b-detail__main-aside-desc zoomInUp" data-wow-delay="0.5s">
									...
									<div class="row">
										...
										<div class="col-xs-12">
											<a href="<?php echo base_url('repo/fill_up/') . '/' . $repo[0]['mot_id'] ?>" class="btn m-btn m-infoBtn btn-lg btn-block">INQUIRE NOW</a>
										</div>	
									</div>
							</aside>
						</div>
