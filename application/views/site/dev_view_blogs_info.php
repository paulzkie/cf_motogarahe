											...
											<header class="b-blog__posts-one-body-head zoomInUp" data-wow-delay="0.5s">
												...
												<ul class="social-area">
													    ...
													    <?php
												    		...
												    		$shareUrl = base_url("blogs/devcontent/". $blogs['blo_slug']) ?>
													    <li><a href="https://twitter.com/intent/tweet?text=<?php echo $tweetBody ?>&url=<?php echo $shareUrl ?>" class="tw rs" target="_blank"><span>twitter</span></a></li>
													    <li><a href="#" class="gp rs"><span>google+</span></a></li>  
													    <li><a href="#" class="yt rs"><span>youtube</span></a></li>
													    <li><a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo $shareUrl ?>" class="ln rs" target="_blank"><span>linkedin</span></a></li>
													    <li><a href="#" class="pn rs"><span>pinterest</span></a></li>
													  </ul>
