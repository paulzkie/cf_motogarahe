  ...
  <link rel="stylesheet" href="<?php echo ADMIN_LTE_PATH?>plugins/daterangepicker/daterangepicker.css">
    ...
    .fa-angle-right {
		...
		<section class="b-pageHeader">
			<div class="container">
				<h1 class=" zoomInLeft" data-wow-delay="0.5s"><?php echo $dealers_motorcycles[0]['mot_model']?> <?php echo $dealers_motorcycles[0]['mot_brand']?> - <?php echo $dealers_motorcycles[0]['dea_name']?></h1>
				...
				<div class="row">
					<div class="col-xs-6">
						<div class="b-contacts__form">
							...
							<form id="contactForm" method="post" class="s-form zoomInUp" data-wow-delay="0.5s">
								...
								<input required type="hidden" name="mot_id" value="<?php echo $dealers_motorcycles[0]['mot_id']?>">
					...
					<div class="col-xs-6">
						...
						<div class="b-contacts__address">
							<img class="img-responsive center-block" src="<?php echo base_url() . $dealers_motorcycles[0]['mop_image']?>" alt="nissan" />
							<div class="b-contacts__address-hours">
								<h2 class="s-titleDet zoomInUp" data-wow-delay="0.5s"><?php echo $dealers_motorcycles[0]['mot_model']?> <?php echo $dealers_motorcycles[0]['mot_brand']?> - <?php echo $dealers_motorcycles[0]['dea_name']?></h2>
							</div>
