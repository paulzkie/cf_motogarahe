...
.b-price {
  ...
  <header class="page-head">
    ...
    <div class="container clearfix">
      ...
      <div class="logo">
        ...
        <a href="<?php echo base_url()?>"><img alt="" src="<?php echo SITE_IMG_PATH?>logo_l.png" class="light"></a>
        <a href="<?php echo base_url()?>"><img alt="" src="<?php echo SITE_IMG_PATH?>logo_d.png" class="dark"></a>
      ...
      <div class="navigation">
        ...
        <nav>
          ...
          <ul>
            ...
            <li class="active"><a href="<?php echo base_url('home/products')?>">Products</a></li>
          </ul>
      ...
      <div class="nav-btn visible-xs">
        ...
        <button type="button"><i class="ti-align-justify"></i></button>
  ...
  <section class="section-services section" id="section-services">
        ...
        <div class="row clearfix">
          ...
          <div class="col-xs-12">
            ...
            <header class="heading-section">
              <h2>Our <span class="font-normal">Products</span></h2>
            </header>
          ...
          <div class="col-md-8 col-md-offset-2">
            ...
            <p class="text-center">“Perfume is the most intense form of memory.”<br><em>- Jean-Paul Guerlain</em></p>
                                        ...
                                        <article class="mix portfolio_category_17 portfolio_category_5  mix_all" style="display: inline-block; opacity: 1;">
                                            ...
                                            <div class="image_holder">
                                              <a class="portfolio_link_for_touch" href="#" target="_self">
                                                <span class="badge b-price">₱ <?php echo number_format( $product['pro_price'], 2) ?></span>
                                                <span class="image">
                                                  <center>
                                                    <img width="1100" height="825" src="<?php echo base_url() . $product['pro_image']?>" class="attachment-full wp-post-image" alt="qode interactive strata">
                                                  </center>
                                                </span>
                                              </a>
                                                ...
                                                <span class="text_outer">
                                                  <span class="text_inner">
                                                    <span class="feature_holder">
                                                        <a class="preview qbutton small white" href="<?php echo base_url() . $product['pro_image']?>" target="_blank">view</a>
                                                      </span>
                                                    </span>
                                                  </span>
                                                </span>
                                            ...
                                            <div class="portfolio_description ">
                                                <h5 class="portfolio_title"><a href="http://demo.qodeinteractive.com/bridge/portfolio_page/stockholm-fashion-destination/" target="_self"><?php echo $product['pro_name']?></a></h5><span class="project_category"><?php echo $product['cat_name']?></span></div>
                                        </article>
                                    <?php endforeach;?>
