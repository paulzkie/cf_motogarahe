					...
					<div class="col-lg-9 col-sm-8 col-xs-12">
						...
						<div id="accordion" class="panel-group mobile">
							<div class="panel">
						      <div class="panel-heading">
						      <h4 class="">
						        <a href="#panelBodyTwo" class="accordion-toggle btn m-btn panel-heading-filter" data-toggle="collapse" data-parent="#accordion">FILTER SEARCH</a>
						        </h4>
						      </div>
								...
								<div class="b-items__cell">
									<a href="<?php echo base_url('motorcycles/info/') . '/' . $motorcycle['mot_slug'] ?>">
										<span class="b-items__cars-one-img img-hover-zoom">
	                                        ...
	                                        <?php else:?>
	                                            <img class='img-responsive  img-result' src="<?php echo base_url("uploads/motorcycles/web2.png")?>" alt='<?php echo $motorcycle['mot_model']?>'/>
	                                        <?php endif;?> 
