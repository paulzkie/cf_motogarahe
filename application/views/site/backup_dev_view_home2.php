...
<!-- 				    <li role="separator" class="divider"></li>
	...
	<div class="container" style="height: 750px!important">
		...
		<form class="b-blog__aside-search" id="formmm" method="post">
			...
			<div class="search-div">
				   <input id="myInput" class="inputSearch" autocomplete="off" type="text" name="mot_model" value="" placeholder="What motorcycle is on your mind?" inputmode="search"/ style="width: 100%">
  ...
  var xhttp = new XMLHttpRequest();
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
           ...
           var datas  = response.motor;
           var motorcycles = [];
           datas.map( data => motor.push(data.mot_brand + ", " + data.mot_model));
            var selectH = $( ".search" ).height();
            console.log(selectH)
         
        }
    };
    xhttp.open("GET", "<?php echo base_url('uploads/json/motorcycles.json') ?>", true);
    xhttp.send();
	...
	$(document).ready(function(){
		...
		var options = {
		 ...
		 $('.js-example-data-array').change(function(){
		 	...
		 	var motModel = myval[1];
		 	$(".inputSearch").val(motModel);
		...
		$(".magnifyingGlass, .newMagGlass").click(function(e){
			e.preventDefault();
