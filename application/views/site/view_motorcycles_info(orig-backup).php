	...
	<style>	
				...
				<header class="b-detail__head s-lineDownLeft zoomInUp" data-wow-delay="0.5s">
					<div class="row">
						<div class="col-sm-8 col-xs-12">
							<div class="b-detail__head-title">
								...
								<ul class="social-area">
								    ...
								    <li><a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=<?php echo current_url()?>', '_black', 'location=yes,height=570,width=520,scrollbars=yes,status=yes' )" class="fb fa fa-facebook"><span> facebook</span></a></li>
								    <li><a href="#" class="tw fa fa-twitter"><span> twitter</span></a></li>
								    <li><a href="#" class="gp fa fa-google"><span> google+</span></a></li>  
								    <li><a href="#" class="yt fa fa-youtube"><span> youtube</span></a></li>
								    <li><a href="#" class="ln fa fa-linkedin"><span> linkedin</span></a></li>
								    <li><a href="#" class="pn fa fa-pinterest-p"><span> pinterest</span></a></li>
								  </ul>


								<a onclick="goBack()" href="#!" style="color: #e44d26;"><h5><i class="fa fa-arrow-left" aria-hidden="true"></i> Go Back to Motorcycles</h5></a>
							</div>
						</div>
						<div class="col-sm-4 col-xs-12">
							<h3 style="    margin-top: 10px;text-align: center;">This is an indicative price and subject to change without prior notice.</h3>
						...
						<!-- <div class="text-center col-sm-4 col-xs-12">
							<h3 style="    margin-top: 10px;">This is an indicative price and subject to change without prior notice.</h3>
						</div> -->
					</div>
				</header>
				<div class="b-detail__main">
							...
							<div class="b-detail__main-info">
								<div class="b-detail__main-info-images zoomInUp" data-wow-delay="0.5s">
									<div class="row m-smallPadding">
										<div class="col-xs-10">
											<ul class="b-detail__main-info-images-big bxslider enable-bx-slider" data-pager-custom="#bx-pager" data-mode="horizontal" data-pager-slide="true" data-mode-pager="vertical" data-pager-qty="<?php echo count($motorcycles_pictures)?>">
										...
										<div class="col-xs-2 pagerSlider pagerVertical">
											<div class="b-detail__main-info-images-small" id="bx-pager">
												...
												<?php if ( isset( $motorcycles_pictures ) ):$y=0;?>
						                            <?php foreach($motorcycles_pictures as $motorcycles_picture): ?>
					...
					<div class="row">	
						...
						<div class="col-md-4 col-xs-12">
							...
							<img class="center-block promo-sticky" src="<?php echo base_url('uploads/promo/Promoimage360x360.jpg') ?>">
							</a>
						</div>
					</div>
					<div class="row">	
		...
		<script type="text/javascript">
			...
			$(window).scroll(function() {
					    ...
					    if(height >= 673) {
					        // do something
					        $('.promo-sticky').addClass('sticky-el');
					        // $('.promo-sticky').fadeIn('slow');

					    }
					    else{
					        $('.promo-sticky').removeClass('sticky-el');

					    }
					    if(height < 1302 ){
					        $('.promo-sticky').removeClass('fadeEffect');
					    }
					    if(height >= 1302){
					        $('.promo-sticky').addClass('fadeEffect');
					        setTimeout(function(){
					        $('.promo-sticky').removeClass('sticky-el');
