...
.div-search{
  ...
  <nav class="desktop">
    ...
    <!-- end of row -->
    <div class=" container z-negative-1">
        <div class="row">
            <div class="col-md-3 col-sm-6 col-6 mb-3">
                <img src="<?php echo base_url() ?>resources/site/newui-assets2/poster/pogs.png" class="img-fluid">
            </div>
            <div class="col-md-3 col-sm-6 col-6 mb-3">
                <img src="<?php echo base_url() ?>resources/site/newui-assets2/poster/beatsss.png" class="img-fluid">
            </div>
            <div class="col-md-3 col-sm-6 col-6 mb-3">
                <img src="<?php echo base_url() ?>resources/site/newui-assets2/poster/vegs.png" class="img-fluid">
            </div>
            <div class="col-md-3 col-sm-6 col-6 mb-3">
                <img src="<?php echo base_url() ?>resources/site/newui-assets2/poster/barakoii.png" class="img-fluid">
            </div>
        </div>
    </div> 
    <!-- end of row -->
