  ...
  .d-xxl-block {
    ...
    <?php
            if($this->uri->segment(1)=="motorcyclespromo"){ ?>
              ...
              <img src="<?php echo base_url() ?>resources/site/newui-assets2/landingimg/banner/yamahapromo.jpeg" style="width: 100%;height: 300px;">
              </div>
             ...
             <?php }else if($this->uri->segment(1)=="motorcyclespromogms"){ ?>
              <div class="col-md-12 desktopbanner" align="center">
              <img src="<?php echo base_url() ?>resources/site/newui-assets2/poster/gmsmechanics3.jpg" style="width: 60%;height: auto;">
              </div>
              <div class="col-md-12 mobilebanner" align="center">
        ...
        <div class="container">
            ...
            <div class="row d-flex flex-row">
                ...
                <div class="col-lg-3 mb-center">
                    ...
                    <?php
                    if($this->uri->segment(1)=='motorcyclespromogms'){
                      echo '<span class="d-block notice"><b class="text-danger">*</b>Available in Metro Manila only.</span>';
                    }
                    ?>
                    
                    <!-- <a href="<?php echo base_url('compare') . "/add_new_motorcycle/" . $motorcycles[0]['mot_id']?>" class="d-block offerButton">+ ADD TO COMPARE</a> -->
                    <form method="POST" id="loadForm" action="<?php echo base_url('motorcyclespromogms/promodetails')?>">
                    <!-- 14.627635199999999 -->
                    <!-- 121.06792959999999 -->
