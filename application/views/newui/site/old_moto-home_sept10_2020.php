                ...
                <div class="col-lg-10">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a href="<?php echo base_url('tvs') ?>">TVS  <img class="ex-logo" src="<?php echo base_url() ?>resources/site/tvs-assets/tvslogov2.png"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2">
    ...
    <div class="container sponsors">
        <div class="row">
            <div class="col-sm col-4 text-center ">
              <a class="" href="<?php echo base_url('tvs') ?>" target="_blank"><img src="<?php echo base_url() ?>resources/site/newui-assets2/home/tvslogov2.png" class="img-fluid tvs-home"></a>
            </div>
            <div class="col-sm col-4 text-center">
                <a class="" href="https://imprintcustomsph.com/" target="_blank"><img src="<?php echo base_url() ?>resources/site/newui-assets2/home/imprint-bikes.png" class="img-fluid imprint-home"></a>
            </div>
            <div class="col-sm col-4 text-center">
                <a class="" href="https://gopro.com/en/ph/" target="_blank"><img src="<?php echo base_url() ?>resources/site/newui-assets2/home/gopro.png" class="img-fluid gopro"></a>
            </div>
            
        </div>
        <!-- <div class="footer-ads">
           <a class="" href="<?php echo base_url('tvs') ?>" target="_blank"><img src="<?php echo base_url() ?>resources/site/newui-assets2/home/footer1.jpg" class="img-fluid "></a>
        </div> -->
