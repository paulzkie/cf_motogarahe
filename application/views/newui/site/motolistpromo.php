     ...
     <div class="container">
                ...
                <?php
                    if($this->uri->segment(1)=="motorcyclespromo"){
                      echo '<div class="col-md-12 desktopbanner" id="desktopbanner" align="center">
                       <img src="'.base_url().'resources/site/newui-assets2/landingimg/banner/gms.jpeg" style="width: 60%;height:350px;">
                        </div>';
                   }
                    else{
                ?>   
      ...
      <!-- mobile filter start-->
          <?php
             ...
             <img src="'.base_url().'resources/site/newui-assets2/landingimg/banner/gms.jpeg" style="width: 100%;">
              </div>';
             }
              else{
          ?> 
...
<script>
    ...
    function load_data(limit, offset)
    {
      ...
      if(getpromourl=="motorcyclespromo"){
          $.ajax({
            url:"<?php echo base_url(); ?>motorcycles/loadmotorpromo",
            method:"post",
            data:{
              limit:limit, 
              offset:offset,
 ...
 function loadAds(){
      ...
      var place3 = `<div data-type="lg" class="col-lg-4 col-md-6 col-sm-6 col-6 moto-col mot_result ads">
                      <a href="#">
                        <img class="p-4 ads-img" src="<?php echo base_url() ?>/resources/site/newui-assets2/home/Shellads.jpg" alt="Z250SL" width="300">
                      </a>
                  </div>`;
