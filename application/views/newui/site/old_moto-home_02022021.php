                ...
                <div class="col-lg-10">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a href="<?php echo base_url() ?>motorcycles/search/all/brand/type/transmission/diplacement/engine-type">NEW MOTORCYCLE</a>
                            ...
                            <div class="card card-body col-lg-12">
                                <div class="col-lg-12 d-flex">
                                    <select name="mot_brand" class="browser-default col-6">
                                        ...
                                        <option  value="bajaj">Royal-Enfield</option>
    ...
    <div class=" sponsors">
        ...
        <div class="container">
            <div class="row">
                ...
                <a class="" href="<?php echo base_url('tvs') ?>" target="_blank"><img src="<?php echo base_url() ?>uploads/motoads/motul1.jpg" class="img-fluid "></a>
                </div>
                <!-- /.col -->
                <div class="col-sm-3 col-3 text-center mb-3">
                    <a class="" href="https://imprintcustomsph.com/" target="_blank"><img src="<?php echo base_url() ?>resources/site/newui-assets2/home/ads_imp_new1.jpg" class="img-fluid "></a>
                </div>
                <!-- /.col -->
                <div class="col-sm-3 col-3 text-center mb-3">
                    <a class="" href="https://gopro.com/en/ph/" target="_blank"><img src="<?php echo base_url() ?>resources/site/newui-assets2/home/9max.jpg" class="img-fluid "></a>
                </div>
                <!-- /.col -->
                <div class="col-sm-3 col-3 text-center mb-3">
                ...
                <!-- /.col -->
                <!-- <div class="col-lg-12 col-md-12 col-12 mt-2 mb-4 text-center">
