...
<div class="body-content">
  ...
  <section id="section-check" class="container">
    ...
    <?php   if($mot_diplacement != 'diplacement' ){ echo '<button type="button" class="btn res-btn m-2" onClick="display_remove_btn('.$mot_diplacement.')"  data-value="'.$mot_diplacement.'">'. $mot_diplacement .'   <span >X</span></button>'; } ?>
    </span>  
