  ...
  .d-xxl-block {
    ...
    <?php
            if($this->uri->segment(1)=="motorcyclespromo"){ ?>
              ...
              <!--<img src="<?php echo base_url() ?>resources/site/newui-assets2/landingimg/banner/yamahapromo.jpeg" style="width: 50%;height: 300px;">-->
              <!--</div>-->
              ...
              <!--</div>-->
             <?php }if($this->uri->segment(1)=="rheanmotorcyclespromo" && $this->uri->segment(3)!='raider-j-crossover'){ ?>
              <div class="col-md-12 desktopbanner" align="center">
              <img src="<?php echo base_url() ?>resources/site/newui-assets2/poster/rheankawasaki.jpeg" style="width: 50%;height: 300px;">
              </div>
              <div class="col-md-12 mobilebanner" align="center">
              <img src="<?php echo base_url() ?>resources/site/newui-assets2/poster/rheankawasaki.jpeg" style="width: 100%;">
              </div>
             <?php }else if($this->uri->segment(1)=="rheanmotorcyclespromo" && $this->uri->segment(3)=="raider-j-crossover"){ ?>
              <div class="col-md-12 desktopbanner" align="center">
              <img src="<?php echo base_url() ?>resources/site/newui-assets2/poster/rheansuzuki.jpeg" style="width: 50%;height: 300px;">
              </div>
              <div class="col-md-12 mobilebanner" align="center">
              <img src="<?php echo base_url() ?>resources/site/newui-assets2/poster/rheansuzuki.jpeg" style="width: 100%;">
              </div>
             <?php }   ?>
        ...
        <div class="container">
            ...
            <div class="row d-flex flex-row">
                            ...
                            <?php foreach($motorcycles_pictures as $motorcycles_picture): ?>
                                ...
                                <?php else:?>
                                    <div class="carousel-item ">
                                        ...
                                        alt="<?php echo $motorcycles[0]['mot_model']?>" title="<?php echo $motorcycles[0]['mot_brand'].' '.$motorcycles[0]['mot_slug']?> 2021">
                                    </div>
                                <?php endif;?>
                                <?php endforeach;?>
                                <?php endif;?> 
                ...
                <div class="col-lg-3 mb-center">
                    ...
                    <form method="POST" id="loadForm" action="<?php 
                    if($this->uri->segment(1)=="motorcyclespromo"){
                      echo base_url('motorcyclespromo/promodetails');
                    }else{
                      echo base_url('rheanmotorcyclespromo/promodetails');
                    }
                    ?>">
                    <!-- 14.627635199999999 -->
                    <!-- 121.06792959999999 -->
                    ...
                    <button type="submit" id="dealers_mode" value="dealers_mode" name="dealers_mode" class="d-block dealers col-md-12"><i class="fa fa-map-marker"></i> FIND DEALERS</button>
            ...
            <div class="row d-flex flex-row mb-3">
                ...
                <div data-type="lg" class="col-lg-3 col-md-3 col-sm-6 col-6  text-center ads">
                      <a href="#">
                        <img class="p-4 ads-img" src=" <?php echo base_url() ?>/resources/site/newui-assets2/home/Shellads.jpg" alt="shell v-power" width="300">
                      </a>
                </div>
                <div data-type="lg" class="col-lg-3 col-md-3 col-sm-6 col-6  text-center ads">
                      <a href="#">
            ...
            <!-- <div class="tab-pane" id="tabs-2" role="tabpanel"> -->
              <div class="" id="tabs-1" role="tabpanel">
                <div class="container">
                    <div class="row specs">
                        <div class="col-6">
                            <h1 class="title-tab">SPECS OF<?php echo " ".date('Y')." ".$motorcycles[0]['mot_brand'] ." ". $motorcycles[0]['mot_model']?></h1>
