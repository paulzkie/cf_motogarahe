<div class="row">
    ...
    <div class="col-md-9">
        <!-- img src="<?php echo $project_img[0]['set_desc']; ?>" class="img img-responsive">
            ...
            <div class="box-body no-padding">
                ...
                <div class="table-responsive mailbox-messages">
                    <table id="example1" class="table table-hover table-striped tablesorter">
                        ...
                        <?php $x = 1; if ( isset( $projects ) ):?>
                            <?php foreach($projects as $project): ?>
                                <tr>
                                    <!-- <td><input type="checkbox"></td> -->
                                    <td><p><?php echo $x?></p></td>
                                    <td>
                                        <img src="<?php echo $project['pro_image'] ?>" class="img-responsive">
                                    </td>
                                    <!-- <td>
                                        <img src="<?php echo $project['pro_image'] ?>">
                                    </td> -->
                                    <td><a href="<?php echo base_url() . 'admin/projects/view/' . $project['pro_id']?>">
                                        <?php echo $project['pro_name'] ?>
                                    </a></td>
                                    <td><?php echo $project['pro_image'] ?></td>
                                    <td><?php echo date("F j, Y, g:i a",strtotime($project['pro_created'])) ?></td>
                                    <td>
                                        <?php
                                            $label = '';

                                            if ( $project['pro_type'] == 'accomplished' ) {
                                                $label = 'label-primary';
                                            } elseif ( $project['pro_type'] == 'on-going' ) {
                                                $label = 'label-primary';
                                            }
                                        ?>
                                        <span class="label <?php echo $label;?>"><?php echo $project['pro_type'] ?></span>
                                    </td>
                                    <td>
                                        <?php
                                            $label = '';

                                            if ( $project['pro_status'] == 'published' ) {
                                                $label = 'label-success';
                                            } elseif ( $project['pro_status'] == 'draft' ) {
                                                $label = 'label-warning';
                                            } elseif ( $project['pro_status'] == 'deleted' ) {
                                                $label = 'label-danger';
                                            }
                                        ?>
                                        <span class="label <?php echo $label;?>"><?php echo $project['pro_status'] ?></span>
                                    </td>
                                    <td>    
                                        <div class="tools">
                                            <?php if ( $this->session->userdata('acc_id') == 1 ) :?>
                                            <a href="<?php echo base_url() . 'admin/projects/edit/' . $project['pro_id']?>"><i class="fa fa-edit"></i></a>
                                            <a href="<?php echo base_url() . 'admin/projects/delete/' . $project['pro_id']?>"><i class="fa fa-trash-o"></i></a>
                                            <?php endif;?>
                                        </div>
                                    </td>
                                </tr>
