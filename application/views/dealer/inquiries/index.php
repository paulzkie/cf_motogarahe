                        ...
                        <?php $x = 1; if ( isset( $inquiries ) ):?>
                            ...
                            <?php foreach($inquiries as $inquiry): ?>
                                <tr>
                                    ...
                                    <td>    
                                        <div class="tools">
                                            <?php if ( $this->session->userdata('acc_type') == 'branch'):?>
                                            <a href="<?php echo base_url() . 'dealer/inquiries/edit/' . $inquiry['inq_id']?>"><i class="fa fa-edit"></i></a>
                                            <!-- <a href="<?php echo base_url() . 'dealer/inquiries/delete/' . $inquiry['inq_id']?>"><i class="fa fa-trash-o"></i></a> -->
                                            <?php endif;?>
                                        </div>
                                    </td>
                                </tr>
