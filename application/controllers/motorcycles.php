...
// 		}
		...
		$header['header_title'] = $content['motorcycles'][0]['mot_brand'].' '. $content['motorcycles'][0]['mot_model']." Philippines Price and Specs | Motogarahe.com". " - ₱" . number_format( $content['motorcycles'][0]['mot_srp'], 2);
        $header['header_desc'] = "Buy your ".$content['motorcycles'][0]['mot_keyword']." for the price of ₱".$content['motorcycles'][0]['mot_srp'].". through The #1 Online Motorcycle Marketplace in the Philippines and experience an easier, safer, and â€œsulitâ€ way of buying the perfect ride for you.";
 ...
 //    			}
	...
	public function details($dealer_slug, $slug, $dem_id) {
		...
		//$header['header_desc'] = $content['motorcycles'][0]['mot_desc'] != '' ? $content['motorcycles'][0]['mot_desc'] : "Buy ".$content['motorcycles'][0]['mot_keyword']." online at motogarahe.com. Discount and Promotions sale on all motors.";
		$header['header_title'] = $content['motorcycles'][0]['mot_model'] ." Philippines Price and Specs | Motogarahe.com". " - ₱" . number_format( $content['motorcycles'][0]['mot_srp'], 2);
        $header['header_desc'] = "Buy your ".$content['motorcycles'][0]['mot_keyword']." for the price of ₱".$content['motorcycles'][0]['mot_srp'].". through The #1 Online Motorcycle Marketplace in the Philippines and experience an easier, safer, and â€œsulitâ€ way of buying the perfect ride for you.";
		...
		foreach($data as $motorcycle)
			{
				...
				title="'.$motorcycle['mot_brand'].' '.$motorcycle['mot_slug']. '" width="300" height=""></a>
				...
				if($motorcycle['mot_brand']== "Royal-Enfield"){
					$output .= '<img class="brand-logo" src="'.base_url().'resources/site/newui-assets2/newlogomotor/royal-enfield.png"  width="50" height="50">';
				}
				if($motorcycle['mot_brand']== "CFMOTO"){
					$output .= '<img class="brand-logo" src="'.base_url().'resources/site/newui-assets2/newlogomotor/cfmoto.jpeg"  width="50" height="30">';
				}
				if($motorcycle['mot_brand']== "MV-Agusta"){
					$output .= '<img class="brand-logo" src="'.base_url().'resources/site/newui-assets2/newlogomotor/mvagusta.jpeg"  width="50" height="30">';
				}
				if($motorcycle['mot_brand']== "Bristol"){
					$output .= '<img class="brand-logo" src="'.base_url().'resources/site/newui-assets2/newlogomotor/bristol.jpeg"  width="50" height="30">';
				}
				if($motorcycle['mot_brand']== "Husqvarna"){
					$output .= '<img class="brand-logo" src="'.base_url().'resources/site/newui-assets2/newlogomotor/husqvarna.jpeg"  width="50" height="30">';
				}
